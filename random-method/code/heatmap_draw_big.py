...
# 读取 excel 文件
df = pd.read_excel('comm_conceal_big.xlsx')
...
ax0=sns.heatmap(cd_attack, linewidths=.4, xticklabels=['FG', 'LP', 'LOU', 'INF'],yticklabels=['BA10000', 'ER10000','WS10000','US-Grid','DBLP','PubMed'],cbar=False, ax=axs[0], vmin=vmin)
...
plt.savefig(r'C:/Users/hello/Desktop/comm_heatmap_big', dpi=200, bbox_inches='tight')
plt.show()
